...
export const metadata: { title: string; description: string } = { title: "Privacy Policy", description: "Privacy Policy for PlusOne." };
    ...
    <div className="min-h-screen bg-surface-999">
      <div className="sticky top-16 z-40 bg-surface-999/90 backdrop-blur-2xl border-b border-white/5">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          <div className="flex items-center justify-between h-12">
            ...
            <div className="flex items-center gap-2 text-xs text-white/20"><Shield size={12}/>Privacy Policy</div>
          </div>
        </div>
      </div>
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-12 sm:py-16">
        <div className="mb-10">
          ...
          <p className="text-white/30">Last Updated: October 1, 2024 · This page redirects to our main Privacy Policy.</p>
        </div>
        <div className="rounded-2xl border border-plus-purple-500/15 bg-plus-purple-500/5 p-6 text-center">
          <p className="text-white/50 text-sm mb-4">You're viewing the Privacy Policy.</p>
          <Link href="/legal/privacy" className="inline-flex items-center gap-2 px-5 py-2.5 bg-gradient-to-r from-plus-blue-500 via-plus-purple-500 to-plus-pink-500 rounded-xl text-white font-medium text-sm hover:scale-[1.02] transition-all">
