...
export const metadata: Metadata = { title: "Campus Ambassador", description: "Information about campus ambassador for PlusOne." };
      ...
      <div className="sticky top-16 z-40 bg-surface-999/90 backdrop-blur-2xl border-b border-white/5">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          <div className="flex items-center justify-between h-12">
            ...
            <div className="flex items-center gap-2 text-xs text-white/20"><Shield size={12}/>Campus Ambassador</div>
          </div>
        </div>
      </div>
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-12 sm:py-16">
        <div className="mb-10">
          <h1 className="text-3xl sm:text-4xl font-black text-white tracking-tight mb-3">Campus Ambassador</h1>
          <p className="text-white/30 max-w-2xl">Information about our campus ambassador programme.</p>
        </div>
        <div className="rounded-2xl border border-plus-purple-500/15 bg-plus-purple-500/5 p-6 text-center">
          <p className="text-white/50 text-sm mb-4">This page is under construction. Stand by for campus ambassador info.</p>
