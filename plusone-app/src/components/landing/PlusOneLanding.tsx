...
export default function PlusOneLanding({ isLoggedIn = false }: { isLoggedIn?: boolean }) {
  ...
  return (
    <main id="top" className="plusone-page">
      ...
      <section id="cta" className="section-wrap cta-section"><div className="cta-orbit" /><Reveal><div className="status-pill"><span className="status-dot" /> Coming soon to your city</div><h2>Stop being lonely.<br /><em>Secure your spot.</em></h2><p>Get early access to verified companions and hefty hosting side-hustles in your city.</p><button className="button button-primary" type="button" onClick={() => showNotice('You are on the early access list.')}>Join the waitlist <ArrowRight size={16} /></button></Reveal></section>
