...
export default function PlusOneLanding({ isLoggedIn = false }: { isLoggedIn?: boolean }) {
  ...
  return (
    <main id="top" className="plusone-page">
      ...
      <section className="section-wrap quote-section"><Reveal><div className="quote-mark">&ldquo;</div><blockquote>I made ₹45,000 last month just by hosting coffee dates and studying sessions. PlusOne is the ultimate side hustle.</blockquote><div className="quote-credit"><span className="credit-avatar">JM</span><span>Jamie M. <small>Earned ₹45k · Host in Mumbai</small></span></div></Reveal></section>
